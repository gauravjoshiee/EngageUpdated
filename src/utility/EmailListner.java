	...
	public static void sendMail(){
		// Create object of Property file
				...
				try {
					...
					message.setSubject("Automation_Report - "+Constants.SuiteName+" - "+ExcelUtils.getDate("yyyy_MM_dd_hh-mm"));
					...
					String filename = ("Automation_Report_"+Constants.SuiteName+"_"+ExcelUtils.getDate("yyyy_MM_dd_hh-mm")+".html");
